...
const remainingDurations = computed<Record<number, number>>(() => store.state.race.remainingDurations)
...
function onHorseFinished(payload: { horseId: number; roundId: number; lap: number; distance: number }) {
